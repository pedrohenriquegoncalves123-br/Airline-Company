...
function mudarMenu() {
    if (window.scrollY < 150) {
        ...
        cabecalho.style.transition = ".335s ease-in-out";
...
const verficCardViagens = () => {
    const itemMenuTodos = document.getElementById("todos");
    const itemMenuInter = document.getElementById("inter");
    const itemMenuDomestico = document.getElementById("domestico");

    const cardInter = document.getElementById("cardInter");
    ...
    if (itemMenuTodos.checked) {
        ...
        cardInter.classList.add("card-vs");
        cardDomestic.classList.add("card-vs");
    }

    if (itemMenuInter.checked) {
        itemMenuInter.classList.add("ativo");
        cardInter.classList.add("card-vs");
        cardDomestic.classList.remove("card-vs");
        cardDomestic.classList.add("card-hidden");
    }
}
